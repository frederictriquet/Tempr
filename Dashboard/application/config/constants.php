...
/* TEMPR */
/* modify Deploy/Vagrant/roles/dashboard_role/templates/constants.php.j2 according to following data */
define('TEMPR_ES_HOST', '172.16.100.10:9200');
define('TEMPR_STORE_HOST', 'localhost');
define('TEMPR_MQ_HOST', 'localhost');
define('TEMPR_DB_HOSTFULL', 'pgsql:host=172.16.100.10;dbname=tempr');
define('TEMPR_DB_USER', 'tempr');
define('TEMPR_DB_PASS', 'vierge');
define('TEMPR_DB_NAME', 'tempr');
define('WWW_TEMPR_ME', 'https://www.local.tempr.me');
...
define('S3KEY','AKIAIWQ6HFIWZVUC7JLQ');
define('S3SECRET','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');
define('S3REGION','us-west-2');
define('S3BUCKET','tempr.co.dev.oregon');
